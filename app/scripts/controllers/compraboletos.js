...
angular.module('boletosApp')
  .controller('CompraboletosCtrl', function ($scope) {
    ...
    $scope.serchResult = [
      {horario:'9:30', terminalSalida:'DF', terminalLlegada:'Guerrero', precio: '500.50', tiempoEstidmado:'10.5hrs', disponibles:'5/40'},
      {horario:'10:00', terminalSalida:'Guerrero', terminalLlegada:'Veracruz', precio: '500.50', tiempoEstidmado:'10.5hrs', disponibles:'5/40'},
      {horario:'19:30', terminalSalida:'Guerrero', terminalLlegada:'Veracruz', precio: '500.50', tiempoEstidmado:'10.5hrs', disponibles:'5/40'},
      {horario:'21:30', terminalSalida:'Guerrero', terminalLlegada:'Veracruz', precio: '500.50', tiempoEstidmado:'10.5hrs', disponibles:'5/40'}
    ];
